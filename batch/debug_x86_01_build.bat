...
rem -----------------------------------------------------
mkdir ..\..\Gemini-Desktop-MSVC2013-32bit-Debug & pushd ..\..\Gemini-Desktop-MSVC2013-32bit-Debug

rem -----------------------------------------------------
rem Create Visual Studio Project (x86) - 소스로부터 x86용 VS 프로젝트를 생성해준다.
rem -----------------------------------------------------
echo on
cmake -G "Visual Studio 12 2013" "..\Gemini" -DCMAKE_PREFIX_PATH="C:\apps\Qt5.5.1-x86\5.5\msvc2013\lib\cmake"