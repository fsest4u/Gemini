...
{
	m_ProgressWidget->InitProgress("Extract", 0, m_CSVModel->rowCount(), CalcCPDlg::CP_MRBLUE, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Calculate", CSV_START_ROW, m_CSVData.size(), CalcCPDlg::CP_MRBLUE, CalcCPDlg::CP_MAX);
