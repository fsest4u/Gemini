...
{
	m_ProgressWidget->InitProgress("Book", ROW_AMOUNT, m_BookList.count(), CalcCPDlg::CP_MAX, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_KYOBO, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_NAVER, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_RIDI, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_MUNPIA, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_MRBLUE, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_BAROBOOK, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_BOOKCUBE, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_EPYRUS, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_OEBOOK, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_ONESTORE, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_KAKAO, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_COMICO, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_TOCSODA, CalcCPDlg::CP_MAX);
...
void CSVTotalBook::MakeBookJustoon(QStandardItemModel* item)
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_JUSTOON, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_GOOGLE, CalcCPDlg::CP_MAX);
...
{
	m_ProgressWidget->InitProgress("Book", CSV_TOTAL_ROW, item->rowCount(), CalcCPDlg::CP_KEPUB, CalcCPDlg::CP_MAX);
