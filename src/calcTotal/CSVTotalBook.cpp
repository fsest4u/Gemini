...
void CSVTotalBook::InitBookData()
{
	...
	m_CSVModel = new QStandardItemModel(ROW_MAX, COLUMN_MAX);
...
void CSVTotalBook::SetBookTable(int column, QString total, QString calc, QString author, QString rank)
{
	//set data
